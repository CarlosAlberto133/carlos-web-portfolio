    ...
    data() {
        return {
            ...
            cards: [
                ...
                { id: 2, isMouseOver: false, type: 'frontEnd', gifPath: "fightclub.gif", staticImagePath: 'figth.svg', link: 'https://figth-club-vercel.vercel.app', gifPathInfo: 'O projeto FightClub é um site onde você gamer pode se cadastrar em um dos 3 jogos diponíveis e entrar no rank das lutas, sendo atualizado sempre que você compartilha os dados.' },
                { id: 3, isMouseOver: false, type: 'frontEnd', gifPath: "vagas.gif", staticImagePath: 'vagas.svg', link: 'https://vagas-sooty.vercel.app', gifPathInfo: 'O Vagas é um site onde você pode cadastrar uma vaga de emprego para sua empresa' },
                { id: 4, isMouseOver: false, type: 'javascript', gifPath: "mario.gif", staticImagePath: 'mario.svg', link: 'https://mario-flame.vercel.app', gifPathInfo: 'Este é um simples jogo do Mário feito em JavaScript' },
                { id: 5, isMouseOver: false, type: 'backEnd', gifPath: "parking-control.gif", staticImagePath: 'parking-control.svg', link: 'https://github.com/CarlosAlberto133/Parking-Control', gifPathInfo: 'O Parking-Control é um CRUD feito com Spring Boot ultilizando o Postgress como banco de dados' },
                { id: 6, isMouseOver: false, type: 'frontEnd', gifPath: "pokemon.gif", staticImagePath: 'pokemon.svg', link: 'https://pokedex-vercel-seven.vercel.app', gifPathInfo: 'O projeto Pokemon é um projeto que simula uma pokebola do jogo pokemon, onde fiz uso de bastante animações' },
                { id: 7, isMouseOver: false, type: 'frontEnd', gifPath: "monte-seu-hamburguer.gif", staticImagePath: 'monte-seu-hamburguer.svg', link: 'https://github.com/CarlosAlberto133/monteseuhamburguer', gifPathInfo: 'O projeto Monte Seu Hamburguer é um site de pedidos de sanduíches, onde você faz seu pedido, e logo após ele vai para um dashboard, onde você pode editar e completar o pedido.' },
                { id: 8, isMouseOver: false, type: 'design', gifPath: "podcastStore.gif", staticImagePath: 'podcastStore.svg', link: 'https://www.behance.net/gallery/144386723/PodcastStore-Ui-Ux-Design-Adobe-XD', gifPathInfo: 'O PodcastStore é um design de site que fiz para agrupar todos os podcast em um só lugar, podendo ganhar recompensas ao assistir por ele' },
                { id: 9, isMouseOver: false, type: 'design', gifPath: "bangeek.gif", staticImagePath: 'bangeek.svg', link: 'https://www.behance.net/gallery/141952275/Bangeek-UI-UX-Design-Adobe-XD-Photoshop', gifPathInfo: 'O Bangeek é um banco para nerds/gamers onde você pode ter todo o conforto na palma da sua mão e ainda ganhar prêmios' }
            ],
            isMouseOver: false
        };
    },
