    ...
    data() {
        return {
            ...
            cards: [
                ...
                { id: 3, isMouseOver: false, type: 'frontEnd', gifPath: "tribelink.gif", staticImagePath: 'tribelink.svg', link: 'https://tribe-link.vercel.app', gifPathInfo: 'O Tribelink é um projeto cujo o objetivo é relembrar as comunidades do Orkut, onde você pode criar para divulgar sua comunidade, o projeto foi feito por Carlos Alberto e Vanderlei Loureiro.' },
                ...
                { id: 7, isMouseOver: false, type: 'frontEnd', gifPath: "vagas.gif", staticImagePath: 'vagas.svg', link: 'https://vagas-sooty.vercel.app', gifPathInfo: 'O Vagas é um site onde você pode cadastrar uma vaga de emprego para sua empresa' },
                { id: 8, isMouseOver: false, type: 'frontEnd', gifPath: "pokemon.gif", staticImagePath: 'pokemon.svg', link: 'https://pokedex-vercel-seven.vercel.app', gifPathInfo: 'O projeto Pokemon é um projeto que simula uma pokebola do jogo pokemon, onde fiz uso de bastante animações' },
                { id: 9, isMouseOver: false, type: 'frontEnd', gifPath: "monte-seu-hamburguer.gif", staticImagePath: 'monte-seu-hamburguer.svg', link: 'https://github.com/CarlosAlberto133/monteseuhamburguer', gifPathInfo: 'O projeto Monte Seu Hamburguer é um site de pedidos de sanduíches, onde você faz seu pedido, e logo após ele vai para um dashboard, onde você pode editar e completar o pedido.' },
                { id: 10, isMouseOver: false, type: 'design', gifPath: "podcastStore.gif", staticImagePath: 'podcastStore.svg', link: 'https://www.behance.net/gallery/144386723/PodcastStore-Ui-Ux-Design-Adobe-XD', gifPathInfo: 'O PodcastStore é um design de site que fiz para agrupar todos os podcast em um só lugar, podendo ganhar recompensas ao assistir por ele' },
                { id: 11, isMouseOver: false, type: 'design', gifPath: "bangeek.gif", staticImagePath: 'bangeek.svg', link: 'https://www.behance.net/gallery/141952275/Bangeek-UI-UX-Design-Adobe-XD-Photoshop', gifPathInfo: 'O Bangeek é um banco para nerds/gamers onde você pode ter todo o conforto na palma da sua mão e ainda ganhar prêmios' }
            ],
            isMouseOver: false
        };
    },
